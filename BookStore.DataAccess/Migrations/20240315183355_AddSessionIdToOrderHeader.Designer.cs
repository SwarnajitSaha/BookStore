...
namespace BookStore.DataAccess.Migrations
{
    ...
    [Migration("20240315183355_AddSessionIdToOrderHeader")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookStore.Models.Model.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookStore.Models.Model.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookStore.Models.OrderDetail", b =>
                {
                    ...
                    b.HasOne("BookStore.Models.Model.Product", "Prodct_Nev")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("OrderHeader_Nev");

                    b.Navigation("Prodct_Nev");
                });

            modelBuilder.Entity("BookStore.Models.OrderHeader", b =>
                {
                    b.HasOne("BookStore.Models.ApplicationUser", "ApplicationUser_Nev")
                        .WithMany()
                        .HasForeignKey("ApplicationUserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ApplicationUser_Nev");
                });
            ...
            modelBuilder.Entity("BookStore.Models.ShoppingCart", b =>
                {
                    ...
                    b.HasOne("BookStore.Models.Model.Product", "ProductObj")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
